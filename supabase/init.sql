...
-- ==================== BEGIN 007_explicit_data_api_grants.sql ====================
-- ============================================================
--  EXPLICIT DATA API GRANTS
-- ============================================================
-- Supabase Data API access is no longer implicitly granted for new public tables.
-- Keep table access explicit and authenticated-only; RLS policies above still
-- decide which rows each user may read or mutate.
